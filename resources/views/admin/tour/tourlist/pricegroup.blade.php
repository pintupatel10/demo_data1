...
<div class="box">
    <div class="box-header" >
        <h3 class="box-title" style="float:right;">
            <a href="{{ url('admin/tour/'.$detail->id .'/pricegroup/create/')}}" ><button class="btn btn-info" type="button"><span class="fa fa-plus"></span></button></a>
            <a href="{{ url('admin/tour/tourlist/'.$detail->id.'/edit') }}" ><button class="btn btn-default" type="button"><span class="fa fa-refresh"></span></button></a>
        </h3>
    </div>
    <div class="box-body">
        {{ Form::open(array('url' => array('admin/tour/checkpoint/update_display_order'), 'method' => 'post','style'=>'display:inline')) }}
        <table id="example2" class="table table-bordered table-striped">
            ...
            @foreach ($pricegroup as $list)
                ...
                <tr>
                    <td align="center">
                        <a href="{{ url('admin/tour/'.$detail->id.'/pricegroup/'.$list->id.'/edit')}}"> <button class="btn btn-info" type="button"><i class="fa fa-edit"></i></button></a>
                        {{--  <a href="{{ route('admin/tour/'.$detail->id.'/checkpoint/edit/'.$list->id) }}"> <button class="btn btn-info" type="button"><i class="fa fa-edit"></i></button></a> --}}
                    </td>

                    <td>{{ $list['id'] }}</td>
                    <td>{{ $list['title'] }}</td>
                    <?php $emailcout=App\TourPrice::where('pricegroupid',$list['id'])->count()  ;?>
                    <td>{{$emailcout}}</td>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="{{ url('admin/tour/'.$detail->id.'/pricegroup/'.$list->id.'/destroy') }}"  name="delete_item">
