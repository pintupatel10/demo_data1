<hr>
<h1> Tour Checkpoint </h1>
<br>
<div class="box">
    <div class="box-header" >

        <h3 class="box-title" style="float:right;">
            {{ Form::open(['url' => url('admin/tour/'.$detail->id.'/checkpoint'), 'id'=>'checkpoint_form','class' => 'form-horizontal','files'=>true]) }}
            ...
            <a href="{{ url('admin/tour/'.$detail->id .'/checkpoint/create/')}}" ><button class="btn btn-info" type="button"><span class="fa fa-plus"></span></button></a>
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            @foreach ($checkpoint as $list)
                <tr class="ui-state-default" id="arrayorder_{{$list['id']}}">
                    <td align="center">
                        <a href="{{ url('admin/tour/'.$detail->id.'/checkpoint/'.$list->id.'/edit')}}"> <button class="btn btn-info" type="button"><i class="fa fa-edit"></i></button></a>
                    </td>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Delete Tour Checkpoint</h4>
                            </div>
                            <div class="modal-body">
                                <p>Are you sure you want to delete this Tour Checkpoint ?</p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                                <a href="{{ url('admin/tour/'.$detail->id.'/checkpoint/'.$list->id.'/destroy') }}"  name="delete_item">
