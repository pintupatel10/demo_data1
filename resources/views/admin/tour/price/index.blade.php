        ...
        <section class="content-header">
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title"><a href="{{ url('admin/tour/price/create/') }}" ><button class="btn bg-orange margin" type="button">Add Tour Price</button></a></h3>
                </div>
                <!-- /.box-header -->

                <div class="box-body table-responsive">
                    {{ Form::open(array('url' => array('admin/tour/price/update_display_order'), 'method' => 'post','style'=>'display:inline')) }}
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group-horizontal">
                                        <a href="{{ route('admin.tour.price.edit', $list->id) }}"> <button class="btn btn-success" type="button"><i class="fa fa-edit"></i></button></a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Delete Tour Price</h4>
                                        </div>
                                        <div class="modal-body">
                                            <p>Are you sure you want to delete this Tour Price ?</p>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                                            <a href="{{ route('admin.tour.price.destroy',$list['id']) }}" data-method="delete" name="delete_item">
                    ...
                    <div style="text-align:right;float:right;"> @include('admin.pagination.limit_links', ['paginator' => $tourprice])</div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('.assign').click(function(){
            ...
            l.start();
            $.ajax({
                url: '{{url('api/cms/tour/price/assign')}}',
                type: "get",
        ...
        $('.unassign').click(function(){
            ...
            l.start();
            $.ajax({
                url: '{{url('api/cms/tour/price/unassign')}}',
                type: "get",
                data: {'id': user_id,'X-CSRF-Token' : $('meta[name=_token]').attr('content')},
                success: function(data){
                    l.stop();
