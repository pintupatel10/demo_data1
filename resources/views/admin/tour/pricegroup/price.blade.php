<br><br>
<h1> Tour Price Table </h1>
<br>
<div class="box">
    <div class="box-header" >
        <h3 class="box-title" style="float:right;">
            <a href="{{ url('admin/tour/'.$detail."/".$pricegroup->id.'/price/create/')}}" ><button class="btn btn-info" type="button"><span class="fa fa-plus"></span></button></a>
    ...
    <div class="box-body">
        <table id="example1" class="table table-bordered table-striped">
            ...
            @foreach ($tourprice as $list)
                ...
                <tr>
                    <td align="center">
                        <a href="{{ url('admin/tour/'.$detail."/".$pricegroup->id.'/price/'.$list->id.'/edit')}}"> <button class="btn btn-info" type="button"><i class="fa fa-edit"></i></button></a>
                    </td>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="{{ url('admin/tour/'.$detail."/".$pricegroup->id.'/price/'.$list->id.'/destroy') }}" name="delete_item">
