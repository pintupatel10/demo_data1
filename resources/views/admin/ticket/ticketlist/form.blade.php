...
{{--<div class="form-group{{ $errors->has('post') ? ' has-error' : '' }}">--}}
    {{--<label class="col-sm-2 control-label" for="post">Post </label>--}}

    {{--<div class="col-sm-5">--}}

        {{--@foreach (\App\TicketList::$post as $key => $value)--}}
            {{--<label>--}}
                {{--{!! Form::radio('post', $key, null, ['class' => 'flat-red']) !!} <span style="margin-right: 10px">{{ $value }}</span>--}}
            {{--</label>--}}
        {{--@endforeach--}}
...
<div class="form-group{{ $errors->has('ticket_type') ? ' has-error' : '' }}">
    <label class="col-sm-2 control-label" for="ticket_type">Ticket type <span class="text-red">*</span></label>
    <div class="col-sm-5">
        {!! Form::select('ticket_type[]',\App\TicketList::$type, !empty($modes)?$modes:null, ['class' => 'select2 select2-hidden-accessible form-control', 'style' => 'width: 100%','multiple']) !!}
...
<div class="form-group{{ $errors->has('display') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-5">
        ...
        @foreach (\App\TicketList::$display as $key => $value)
            <label>
...
<div class="form-group{{ $errors->has('language') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-5">
        {!! Form::select('language[]',['please Select']+\App\TicketList::$language, !empty($modes_selected)?$modes_selected:null, ['class' => 'select2 select2-hidden-accessible form-control', 'style' => 'width: 100%']) !!}
...
<div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-5">
        ...
        @foreach (\App\TicketList::$status as $key => $value)
            <label>
