<hr>
<h1> Ticket Checkpoint </h1>
<br>
<div class="box">
    <div class="box-header" >

        <h3 class="box-title" style="float:right;">
            {{ Form::open(['url' => url('admin/ticket/'.$detail->id.'/checkpoint'), 'id'=>'checkpoint_form','class' => 'form-horizontal','files'=>true]) }}
            ...
            <a href="{{ url('admin/ticket/'.$detail->id .'/checkpoint/create/')}}" ><button class="btn btn-info" type="button"><span class="fa fa-plus"></span></button></a>
        ...
        <table id="example1" class="table table-bordered table-striped">
            ...
            @foreach ($checkpoint as $list)
                <tr class="ui-state-default" id="arrayorder_{{$list['id']}}">
                    <td align="center">
                        <a href="{{ url('admin/ticket/'.$detail->id.'/checkpoint/'.$list->id.'/edit')}}"> <button class="btn btn-info" type="button"><i class="fa fa-edit"></i></button></a>
                    </td>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Delete Ticket Checkpoint</h4>
                            </div>
                            <div class="modal-body">
                                <p>Are you sure you want to delete this Ticket Checkpoint ?</p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                                <a href="{{ url('admin/ticket/'.$detail->id.'/checkpoint/'.$list->id.'/destroy') }}"  name="delete_item">
...
<script type="text/javascript">
    $(document).ready(function(){
        $('.assign').click(function(){
            ...
            l.start();
            $.ajax({
                url: '{{url('api/cms/ticket/ticketlist/{detailid}/assign')}}',
                type: "get",
        ...
        $('.unassign').click(function(){
            ...
            l.start();
            $.ajax({
                url: '{{url('api/cms/ticket/ticketlist/{detailid}/unassign')}}',
                type: "get",
                data: {'id': user_id,'X-CSRF-Token' : $('meta[name=_token]').attr('content')},
                success: function(data){
                    l.stop();
