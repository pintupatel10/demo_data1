...
<div class="form-group{{ $errors->has('report_price_type') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-5">
        {!! Form::select('report_price_type',[''=>'please Select']+\App\TicketPrice::$report_price_type,null, ['class' => 'select2 select2-hidden-accessible form-control', 'style' => 'width: 100%']) !!}
...
<div class="form-group{{ $errors->has('price') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-5">
        {!! Form::text('price', null, ['class' => 'form-control', 'placeholder' => 'Default Price']) !!}
        @if ($errors->has('price'))
            <span class="help-block">
...
<div class="form-group{{ $errors->has('volume') ? ' has-error' : '' }}">
    <label class="col-sm-2 control-label" for="volume">Volume discount <span class="text-red">*</span></label>

    <div class="col-sm-5">

        @foreach (\App\TicketPrice::$volume as $key => $value)
            <label>
                {!! Form::radio('volume', $key, null, ['class' => 'flat-red']) !!} <span style="margin-right: 10px">{{ $value }}</span>
            </label>
        @endforeach
...
<div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-5">
        ...
        @foreach (\App\TicketPrice::$status as $key => $value)
            <label>
...
<script>
    ...
    $(function (){
        ...
        @if (isset($price))
            @foreach ($price->TicketQuota as $value)
