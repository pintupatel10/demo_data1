                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">ADD Private Tour List </h3>
                        </div>
                        {!! Form::open(['url' => url('admin/privatetour/privatetourlist'), 'class' => 'form-horizontal','files'=>true]) !!}
                        <div class="box-body">
                            ...
                            <div class="form-group{{ $errors->has('link') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <?php
                                        $new=1;
                                    $totalprivate=\App\TourList::orderby('id','DESC')->first();
                                        if($totalprivate){
                                            $new=$totalprivate->id+1;
                                         }
                                    $a=url('privatetour/privatetourlist/'.$new);?>
