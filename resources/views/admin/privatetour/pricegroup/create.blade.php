                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">ADD Private Tour Pricegroup </h3>
                        </div>
                        {!! Form::open(['url' => url('admin/privatetour/'.$detail.'/pricegroup'), 'class' => 'form-horizontal','files'=>true]) !!}
                        <div class="box-body">
                ...
                <strong>{{ $errors->first('description') }}</strong>
                            ...
                            <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    @foreach (\App\TourPricegroup::$status as $key => $value)
                                        <label>
