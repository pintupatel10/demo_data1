...
<div class="form-group{{ $errors->has('language') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-5">
        {!! Form::select('language[]',['please Select']+\App\Hotelcollection::$language, !empty($modes_selected)?$modes_selected:null, ['class' => 'select2 select2-hidden-accessible form-control', 'style' => 'width: 100%']) !!}
...
<div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-5">
        ...
        @foreach (\App\Hotelcollection::$status as $key => $value)
            <label>
...
<div class="box">
    <div class="box-body">
        ...
        <input type="hidden" name="itm_sel" id="itm_sel"
               value="@if(isset($collection['hotel'])){{$collection['hotel']}}@endif">
