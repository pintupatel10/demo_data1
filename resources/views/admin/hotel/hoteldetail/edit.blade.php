                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Edit Hotel List </h3>
                        </div>

                        {!! Form::model($hoteldetail, ['url' => url('admin/hotel/hoteldetail/' . $hoteldetail->id), 'method' => 'patch', 'class' => 'form-horizontal','files'=>true]) !!}
