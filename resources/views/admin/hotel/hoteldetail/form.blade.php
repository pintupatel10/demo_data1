...
<div class="form-group{{ $errors->has('language') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-5">
        {!! Form::select('language',[''=>'Please select']+\App\HotelDetail::$language,null, ['class' => 'select2 select2-hidden-accessible form-control', 'style' => 'width: 100%']) !!}
...
<div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-3">
        ...
        <?php
        if (!empty($hoteldetail->image) && $hoteldetail->image != "") {
        ?>
        <br><img id="DisplayImage" src="{{ url($hoteldetail->image) }}" name="img" id="img" width="150" style="padding-bottom:5px" >
        <?php
        }else{
...
<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
    <label class="col-sm-1 control-label" for="title">Contact email address <span class="text-red">*</span></label>
    <div class="col-sm-5">
        {!! Form::text('email', null, ['class' => 'form-control', 'placeholder' => 'Contact email address']) !!}
        @if ($errors->has('email'))
            <span class="help-block">
...
<div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-5">
        ...
        @foreach (\App\HotelDetail::$status as $key => $value)
            <label>
