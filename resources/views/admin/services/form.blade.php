...
<div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-2">
        ...
        <?php
        if (!empty($services->image) && $services->image != "") {
        ?>
        <br><img id="DisplayImage" src="{{ url($services->image) }}" name="img" id="img" width="150" style="padding-bottom:5px" >
        <?php
        }else{
...
<div class="form-group{{ $errors->has('url') ? ' has-error' : '' }}">
    <label class="col-sm-2 control-label" for="url">Url <span class="text-red">*</span></label>
    <div class="col-sm-5">
...
<div class="form-group{{ $errors->has('language') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-5">
        {!! Form::select('language[]',['please Select']+\App\Servicedetail::$language, !empty($modes_selected)?$modes_selected:null, ['class' => 'select2 select2-hidden-accessible form-control', 'style' => 'width: 100%']) !!}
...
<div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-5">
        ...
        @foreach (\App\Servicedetail::$status as $key => $value)
            <label>
