            ...
            <div class="box">
                ...
                <div class="box-header">
                    <h3 class="box-title" style="float:right;">
                        <a href="{{ url('admin/staff/create/') }}" ><button class="btn btn-info" type="button"><span class="fa fa-plus"></span></button></a>
                        <a href="{{ url('admin/staff/') }}" ><button class="btn btn-default" type="button"><span class="fa fa-refresh"></span></button></a>
                    </h3>
                </div>
                @endif
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach ($staff as $list)
                            ...
                            <tr>
                                ...
                                <td align="center">
                                        @if(Auth::User()->role == "admin") <button class="btn btn-danger" type="button" data-toggle="modal" data-target="#myModal{{$list['id']}}"><i class="fa fa-trash"></i></button> @endif
                                </td>
                            </tr>
