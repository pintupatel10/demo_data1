...
<div id="myDiv4">
    <?php  $inventory_id = ""; ?>
    @if(isset($inventory->TransportationQuota[0]) && !empty($inventory->TransportationQuota[0]))
            <?php $count4 = 1;
            ?>
        @foreach ($inventory->TransportationQuota as $key => $value)
...
<div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-5">
        ...
        @foreach (\App\TransportationInventory::$status as $key => $value)
            <label>
