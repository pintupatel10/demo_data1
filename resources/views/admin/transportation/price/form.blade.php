...
<div class="form-group{{ $errors->has('Weekend/Weekday') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-5">
        {!! Form::select('Weekend/Weekday[]',['please Select']+\App\TransportationPrice::$type, !empty($modes_selected)?$modes_selected:null, ['class' => 'select2 select2-hidden-accessible form-control', 'style' => 'width: 100%']) !!}
...
<div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-5">
        ...
        @foreach (\App\TransportationPrice::$status as $key => $value)
            <label>
...
<script>
    ...
    $(function (){
        ...
        @if (isset($price))
            @foreach ($price->TransportationQuota as $value)
