...
<div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-5">
        ...
        @foreach (\App\TransportationFilter::$status as $key => $value)
            <label>
        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                /* =====================  RIGHT SIDE ===================== */
                        ...
                        if ($mode50[$i] == 'G') {
                        $mm = App\TransportationGroup::where('id', $mode50[$i+1])->first();
                        ?>
                ...
                $("#item-selected").append($(html5));
                        ...
                        if ($mode50[$i] == 'L') {
                        $mm1 = App\TransportationList::where('id', $mode50[$i+1])->first();
                        ?>
