                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Edit Transportation Time Table </h3>
                        </div>

                        {!! Form::model($time, ['url' => url('admin/transportation/'.$detail."/".$detail1.'/timetable/'.$time->id), 'method' => 'patch', 'class' => 'form-horizontal','files'=>true]) !!}

                        <div class="box-body">

                            @include ('admin.transportation.timetable.form')
