...
{{--<div class="form-group{{ $errors->has('post') ? ' has-error' : '' }}">--}}
    ...
    {{--<div class="col-sm-5">--}}
        ...
        {{--@foreach (\App\TransportationList::$post as $key => $value)--}}
            {{--<label>--}}
...
<div class="form-group{{ $errors->has('transportation_type') ? ' has-error' : '' }}">
    <label class="col-sm-2 control-label" for="transportation_type">Transportation Type <span class="text-red">*</span></label>

    <div class="col-sm-5">

        @foreach (\App\TransportationList::$type as $key => $value)
            <label>
                {!! Form::radio('transportation_type', $key, null, ['onclick'=>'calltype1(this.value);']) !!} <span style="margin-right: 10px">{{ $value }}</span>
            </label>
        @endforeach
...
<div class="form-group{{ $errors->has('display') ? ' has-error' : '' }}">
    <label class="col-sm-2 control-label" for="display">Display method <span class="text-red">*</span></label>

    <div class="col-sm-5">

        @foreach (\App\TransportationList::$display as $key => $value)
            <label>
