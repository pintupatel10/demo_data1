<hr>
<h1> Transportation Checkpoint </h1>
<br>
...
<div class="box">
    ...
    <div class="box-header" >
        ...
        <h3 class="box-title" style="float:right;">
            {{ Form::open(['url' => url('admin/transportation/'.$detail->id.'/checkpoint'), 'id'=>'checkpoint_form','class' => 'form-horizontal','files'=>true]) }}
            ...
            <a href="{{ url('admin/transportation/'.$detail->id .'/checkpoint/create/')}}" ><button class="btn btn-info" type="button"><span class="fa fa-plus"></span></button></a>
            <a href="{{ url('admin/transportation/transportationlist/'.$detail->id.'/edit') }}" ><button class="btn btn-default" type="button"><span class="fa fa-refresh"></span></button></a>
            {{ Form::close() }}
    ...
    <div class="box-body">
        {{ Form::open(array('url' => array('admin/transportation/checkpoint/update_display_order'), 'method' => 'post','style'=>'display:inline')) }}
        <table id="example1" class="table table-bordered table-striped">
            <thead>
            <tr>
                <th>Edit</th>
            ...
            @foreach ($checkpoint as $list)
                <tr class="ui-state-default" id="arrayorder_{{$list['id']}}">
                    <td align="center">
                        <a href="{{ url('admin/transportation/'.$detail->id.'/checkpoint/'.$list->id.'/edit')}}"> <button class="btn btn-info" type="button"><i class="fa fa-edit"></i></button></a>
                    </td>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Delete Transportation Checkpoint</h4>
                            </div>
                            <div class="modal-body">
                                <p>Are you sure you want to delete this Transportation Checkpoint ?</p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                                <a href="{{ url('admin/transportation/'.$detail->id.'/checkpoint/'.$list->id.'/destroy') }}"  name="delete_item">
