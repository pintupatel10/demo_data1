                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Edit Transportation Checkpoint </h3>
                        </div>

                        {!! Form::model($checkpoint, ['url' => url('admin/transportation/'.$detail.'/checkpoint/'.$checkpoint->id), 'method' => 'patch', 'class' => 'form-horizontal','files'=>true]) !!}
                        <div class="box-body">
