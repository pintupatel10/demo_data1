...
@section('content')
    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="{{ url('admin/news/layout') }}"> <i class="fa fa-dashboard"></i>  {{ $menu }} </a></li>
            </ol>
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title" style="float:right;">
                        <a href="{{ url('admin/news/layout/create/') }}" ><button class="btn btn-info" type="button"><span class="fa fa-plus"></span></button></a>
                        <a href="{{ url('admin/news/layout/') }}" ><button class="btn btn-default" type="button"><span class="fa fa-refresh"></span></button></a>
                    </h3>
                </div>

                <div class="box-body table-responsive">
                    {{ Form::open(array('url' => array('admin/news/layout/update_display_order'), 'method' => 'post','style'=>'display:inline')) }}
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach ($layout as $list)
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a href="{{ route('admin.news.layout.edit', $list->id) }}"> <button class="btn btn-info" type="button"><i class="fa fa-edit"></i></button></a>
                                </td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Delete News Layout</h4>
                                        </div>
                                        <div class="modal-body">
                                            <p>Are you sure you want to delete this News Layout ?</p>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                                            <a href="{{ route('admin.news.layout.destroy',$list['id']) }}" data-method="delete" name="delete_item">
...
l.start();
$.ajax({
url: '{{url('api/cms/news/layout/assign')}}',
type: "get",
...
l.start();
$.ajax({
url: '{{url('api/cms/news/layout/unassign')}}',
type: "get",
data: {'id': user_id,'X-CSRF-Token' : $('meta[name=_token]').attr('content')},
success: function(data){
    l.stop();
