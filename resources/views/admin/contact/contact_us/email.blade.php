<div id="myDiv1">
    <?php  $attribute_id = ""; ?>
    @if(isset($contact->Contactemail[0]) && !empty($contact->Contactemail[0]))
        <?php $count1 = 1;
        ?>
        @foreach ($contact->Contactemail as $key => $value)
            ...
            <div class="col-sm-12" id="Account1<?php echo $count1; ?>" >
                <div class="form-group">
                    ...
                    <div style="margin-left: 140px;"><a href="javascript:;" onclick="removeEvent1212('Account1<?php echo $count1; ?>','<?php echo $value->id;?>')"></a>
                        <button class="btn btn-danger" type="button" data-toggle="modal" data-target="#myModal{{$value['id']}}"><i class="fa fa-trash"></i></button>
                        <span style="margin-left: 15px;">{{$value->email_receiver}}</span>
                    </div>
                </div>
            </div>
                <div id="myModal{{$value['id']}}" class="fade modal modal-danger" role="dialog">
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="{{url('admin/contact/contact_us/emaildelete/'.$value['id']) }}" data-method="get" name="emaildelete">
            ...
            <div class="col-sm-10" id="Account1">
                <div class="form-group">
                    ...
                    <div class="col-sm-6" style="width: 51.5%;">
                         <input type="email" id="email_receiver" name="email_receiver" class="form-control" >
                    </div>
...
<script>
    function addEvent1212() {
        ...
        newdiv1.innerHTML = "<div class='form-group'>" +
                ...
                "<div class='col-sm-5' style='width: 46%;'><input type='email' id=\"email_receiver" + num1 + "\"  name=\"email_receiver" + num1 + "\"  class='form-control'></div>" +
