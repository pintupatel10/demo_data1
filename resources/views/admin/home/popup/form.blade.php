...
<div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-2">
        ...
        <?php
        if (!empty($popup->image) && $popup->image != "") {
        ?>
        <br><img id="DisplayImage" src="{{ url($popup->image) }}" name="img" id="img" width="150" style="padding-bottom:5px" >
        <?php
        }else{
...
<div class="form-group{{ $errors->has('language') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-5">
        {!! Form::select('language[]',['please Select']+\App\Homepopup::$language, !empty($modes_selected)?$modes_selected:null, ['class' => 'select2 select2-hidden-accessible form-control', 'style' => 'width: 100%']) !!}
...
<div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-5">
        ...
        @foreach (\App\Homepopup::$status as $key => $value)
            <label>
