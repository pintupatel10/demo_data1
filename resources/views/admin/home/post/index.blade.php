            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        ...
                        {!! Form::open(['url' => url('admin/home/post'), 'method' => 'get', 'class' => 'form-horizontal']) !!}
                        <div class="box-body">
                            <div class="form-group{{ $errors->has('language') ? ' has-error' : '' }}">
                                <label class="col-sm-2 control-label" for="language">Language </label>
                                <div class="col-sm-5">
                                    {!! Form::select('language',\App\Homepost::$language1,isset($filter)?$filter:null, ['class' => 'form-control', 'style' => 'width: 100%']) !!}
                                </div>
                            </div>
            ...
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title" style="float:right;">
                        <a href="{{ url('admin/home/post/create/') }}" ><button class="btn btn-info" type="button"><span class="fa fa-plus"></span></button></a>
                        <a href="{{ url('admin/home/post') }}" ><button class="btn btn-default" type="button"><span class="fa fa-refresh"></span></button></a>
                    </h3>
                </div>
                <!-- /.box-header -->

                <div class="box-body table-responsive">
                    {{ Form::open(array('url' => array('admin/home/post/update_display_order'), 'method' => 'post','style'=>'display:inline')) }}
                    <table id="example4" class="table table-bordered table-striped">
                        ...
                        @foreach ($post as $list)
                            ...
                            <tr class="ui-state-default" id="arrayorder_{{$list['id']}}">
                                <td align="center">
                                    <a href="{{ route('admin.home.post.edit', $list->id) }}"> <button class="btn btn-info" type="button"><i class="fa fa-edit"></i></button></a>
                                </td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title">Delete Home Post</h4>
                                        </div>
                                        <div class="modal-body">
                                            <p>Are you sure you want to delete this Home Post ?</p>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                                            <a href="{{ route('admin.home.post.destroy',$list['id']) }}" data-method="delete" name="delete_item">
...
<script>
    ...
    $( function() {
        $( "#sortable" ).sortable({opacity: 0.9, cursor: 'move', update: function() {
            ...
            //alert(order);
            $.post("{{url('api/cms/home/post/reorder')}}", order, function(theResponse) {
...
l.start();
$.ajax({
url: '{{url('api/cms/home/post/assign')}}',
type: "get",
...
l.start();
$.ajax({
url: '{{url('api/cms/home/post/unassign')}}',
type: "get",
data: {'id': user_id,'X-CSRF-Token' : $('meta[name=_token]').attr('content')},
success: function(data){
    l.stop();
