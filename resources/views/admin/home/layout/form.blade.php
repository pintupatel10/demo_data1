...
<div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-10">
        {!! Form::textarea('title', null, ['class' => 'form-control', 'placeholder' => 'Content','rows'=>'10','cols'=>'80', 'id'=>'editor']) !!}
        @if ($errors->has('title'))
            <span class="help-block">
...
<div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-2">
        ...
        <?php
        if (!empty($homelayout->image) && $homelayout->image != "") {
        ?>
        <br><img id="DisplayImage" src="{{ url($homelayout->image) }}" name="img" id="img" width="150" style="padding-bottom:5px" >
        <?php
        }else{
...
<div class="form-group{{ $errors->has('language') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-5">
        {!! Form::select('language[]',['please Select']+\App\Homelayout::$language, !empty($modes_selected)?$modes_selected:null, ['class' => 'select2 select2-hidden-accessible form-control', 'style' => 'width: 100%']) !!}
...
<div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
    ...
    <div class="col-sm-5">
        ...
        @foreach (\App\Homelayout::$status as $key => $value)
            <label>
