...
<div class="box">
    <div class="box-header" >
        <h3 class="box-title" style="float:right;">
            <a href="{{ url('admin/privatetransportation/'.$detail->id .'/pricegroup/create/')}}" ><button class="btn btn-info" type="button"><span class="fa fa-plus"></span></button></a>
    ...
    <div class="box-body">
        {{ Form::open(array('url' => array('admin/privatetransportation/pricegroup/update_display_order'), 'method' => 'post','style'=>'display:inline')) }}
        <table id="example2" class="table table-bordered table-striped">
            ...
            @foreach ($pricegroup as $list)
                ...
                <tr>
                    <td align="center">
                        <a href="{{ url('admin/privatetransportation/'.$detail->id.'/pricegroup/'.$list->id.'/edit')}}"> <button class="btn btn-info" type="button"><i class="fa fa-edit"></i></button></a>
                    </td>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Delete Private Transportation Pricegroup</h4>
                            </div>
                            <div class="modal-body">
                                <p>Are you sure you want to delete this Private Transportation Pricegroup ?</p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                                <a href="{{ url('admin/privatetransportation/'.$detail->id.'/pricegroup/'.$list->id.'/destroy') }}" name="delete_item">
