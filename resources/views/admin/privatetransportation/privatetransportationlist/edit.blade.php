        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Edit Private Transportation List </h3>
                        </div>

                        {!! Form::model($detail, ['url' => url('admin/privatetransportation/privatetransportationlist/' . $detail->id), 'method' => 'patch', 'class' => 'form-horizontal','files'=>true]) !!}
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group{{ $errors->has('link') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-4">
                                    <?php $a=url('privatetransportation/privatetransportationlist/'.$detail->id); ?>
                ...
                <strong>{{ $errors->first('link') }}</strong>
                    ...
                    @include ('admin.privatetransportation.privatetransportationlist.pricegroup')
                    @include ('admin.privatetransportation.privatetransportationlist.checkpoint')
