                ...
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">ADD Private Transportation Pricegroup </h3>
                        </div>
                        {!! Form::open(['url' => url('admin/privatetransportation/'.$detail.'/pricegroup'), 'class' => 'form-horizontal','files'=>true]) !!}
                        <div class="box-body">
