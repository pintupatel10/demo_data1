<br><br>
<h1>Private Transportation Price Table </h1>
<br>
<div class="box">
    <div class="box-header" >
        <h3 class="box-title" style="float:right;">
            <a href="{{ url('admin/privatetransportation/'.$detail."/".$pricegroup->id.'/price/create/')}}" ><button class="btn btn-info" type="button"><span class="fa fa-plus"></span></button></a>
            <a href="" ><button class="btn btn-default" type="button"><span class="fa fa-refresh"></span></button></a>
        </h3>
    </div>
    <div class="box-body">
        {{ Form::open(array('url' => array('admin/privatetransportation/price/update_display_order'), 'method' => 'post','style'=>'display:inline')) }}
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
            <?php $count = 0;?>
            @foreach ($transportationprice as $list)
                <input type="hidden" name="pid<?php echo $count;?>" id="pid<?php echo $count;?>" value="{{ $list['id'] }}" />
                <tr>
                    <td align="center">
                        <a href="{{ url('admin/privatetransportation/'.$detail."/".$pricegroup->id.'/price/'.$list->id.'/edit')}}"> <button class="btn btn-info" type="button"><i class="fa fa-edit"></i></button></a>
                    </td>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Delete Private Transportation Price</h4>
                            </div>
                            <div class="modal-body">
                                <p>Are you sure you want to delete this Private Transportation Price ?</p>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                                <a href="{{ url('admin/privatetransportation/'.$detail."/".$pricegroup->id.'/price/'.$list->id.'/destroy') }}"  name="delete_item">
