...
<div class="col-md-10 col-lg-10 col-sm-10 tour_details_full_bg scroll-dv" style="padding:20px; height: 101%">
    <div class="col-md-12 tour_details_full_bg_page_in zoomInUp scroll-dv">
        ...
        <div class="tour_details_floating text-center" style=""><a href="#0" class="cd-btn">Tour Details</a></div>
    ...
    <div class="cd-panel-container">
        <div class="cd-panel-content">
            <div class="col-md-12 col-lg-12 col-sm-12">
                <div class="col-md-12" style="padding-left:0"> <a href="#0" class="cd-panel-close"><img src="{{url('website/assets/img/chevron-circle-outline.png')}}" style="height:40px; width:40px; padding-right:0px; float: left; margin: -12px 10px" alt="back"> Back </a></div>
                ...
                <div class="tour_details_gallery">
                    @for($i=0;$i<count($transportation['TransportationCheckpoint']);$i=$i+4)
                    <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div>
                        <img src="{{url('website/assets/img/tick.png')}}" alt="tick">
