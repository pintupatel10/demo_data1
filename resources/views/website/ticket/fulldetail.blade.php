...
<div class="col-md-10 col-lg-10 col-sm-10 tour_details_full_bg scroll-dv" style="padding:20px; height: 101%;background: url({{url($ticket->image)}}) no-repeat center center fixed; -webkit-background-size: cover; -moz-background-size: cover;-o-background-size: cover;background-size: cover;">
    <div class="col-md-12 tour_details_full_bg_page_in zoomInUp scroll-dv">

        <h1 class="font-eligible-regular text-center font-white-color" style="color:#{{$ticket->title_color}}">{{$ticket->title}}<br>
            {{$ticket->ticket_code}}</h1>

        <div class="tour_details_floating text-center" style=""><a href="" class="cd-btn">
                @if($cookie == 'English')
                    Details
                @elseif($cookie == '繁中')
                    詳細內容
    ...
    <div class="cd-panel-container">
        <div class="cd-panel-content">
            <div class="col-md-12 col-lg-12 col-sm-12">
                <div class="col-md-12" style="padding-left:0"> <a href="#0" class="cd-panel-close"><img src="{{url('website/assets/img/chevron-circle-outline.png')}}" style="height:40px; width:40px; padding-right:0px; float: left; margin: -12px 10px" alt="back">
                        @if($cookie == 'English')
                            Back
                        @elseif($cookie == '繁中')
                            返回
                ...
                @foreach($TicketPricegroup as $pricegroup)
                    ...
                    <div class="col-md-12 text-center">
                        ...
                        <table class="table table-responsive table-bordered">
                            ...
                            <?php $TicketPrice = \App\TicketPrice::where('pricegroupid',$pricegroup->id)->where('status', 'active')->get(); ?>

                            @foreach($TicketPrice as $price)
                        ...
                        <div class="col-md-12 text-left padding-left-0">
                            ...
                            <a href="{{url('reserve/ticket/'.$menuid.'/'.$pricegroup->id)}}"><button type="submit" class="btn btn-submit-jasbir"><i class="fa fa-calendar"></i> &nbsp;
