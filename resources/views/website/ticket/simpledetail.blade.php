...
<div class="col-md-10 col-lg-10 col-sm-10 padding-0">
    <div class="col-md-2 tour_details_single_banner_bg affix" style="background: url({{url($ticket->image)}}) no-repeat center center fixed; -webkit-background-size: cover; -moz-background-size: cover;-o-background-size: cover;background-size: cover;"> </div>
    <div class="col-md-10 col-lg-10 col-sm-10 padding-left-100-desktop margin-left-15per-desktop">
        <div class="col-md-12" style="padding-top:20px; padding-left:0"> <a href="{{url('ticket/'.$menuid.'ticketfulllist/'.$ticket->id)}}"><img src="{{URL::asset('website/assets/img/chevron-circle-outline.png')}}" style="height:40px; width:40px; padding-right:0px;">
                @if($cookie == 'English')
                    Back
                @elseif($cookie == '繁中')
                    返回
