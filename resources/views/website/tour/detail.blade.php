...
<div class="col-md-10 col-lg-10 col-sm-10 tour_details_full_bg scroll-dv" style="padding:20px; height: 101% ">
    <div class="col-md-12 tour_details_full_bg_page_in zoomInUp scroll-dv">
        ...
        <h1 class="font-eligible-regular text-center font-white-color" >{{$tour->title}}<br>
            {{$tour->tour_code}}</h1>
        ...
        <div class="cd-panel-content">
            <div class="col-md-12 col-lg-12 col-sm-12">
                ...
                <div class="tour_details_gallery">
                    @for($i=0;$i<count($tour['TourCheckpoint']);$i=$i+4)
                    <div class="row">
                ...
                @foreach($tour['TourPricegroup'] as $pricegroup)
                ...
                <div class="col-md-12 text-center">
                    ...
                    <table class="table table-responsive table-bordered">
                        ...
                        @foreach($pricegroup['TourPrice'] as $price)
                    ...
                    <div class="col-md-12 text-left padding-left-0">
                        ...
                        <a href="{{url('toursimplelist/'.$tour->id.'/reserve')}}"><button type="submit" class="btn btn-submit-jasbir"><i class="fa fa-calendar"></i> &nbsp;Reserver Tour</button></a>
