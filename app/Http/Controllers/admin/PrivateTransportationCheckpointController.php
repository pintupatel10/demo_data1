...
class PrivateTransportationCheckpointController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['menu']="Private Transportation checkpoint";
        $data['checkpoint']=TransportationCheckpoint::orderBy('id','ASC')->get();
        return view('admin.privatetransportation.checkpoint.index',$data);
    }
    ...
    public function create($detailid)
    {
        ...
        return view('admin.privatetransportation.checkpoint.create',$data);
    }
    public function store(Request $request,$detailid)
    {
        ...
        Activity::log('PrivateTransportationCheckpoint -'.$tr_checkpoint->title.' [Id = '.$tr_checkpoint->id.'] has been inserted');
    ...
    public function edit($id,$detailid)
    {
        ...
        return view('admin.privatetransportation.checkpoint.edit',$data);
    }
    ...
    public function update(Request $request, $id,$detailid)
    {
        ...
        Activity::log('PrivateTransportationCheckpoint -'.$checkpoint->title.' [Id = '.$checkpoint->id.'] has been Updated');
    ...
    public function destroy($id,$detailid)
    {
        ...
        Activity::log('PrivateTransportationCheckpoint  -'.$checkpoint->title.' [Id = '.$checkpoint->id.'] has been deleted');
        return redirect('admin/privatetransportation/privatetransportationlist/'.$id.'/edit');
    }
    ...
    public function update_display_order(Request $request)
    {
        ...
        return redirect('admin/privatetransportation/checkpoint');
    }
}
